...
export const I18N = {
  en: {
    ...
    range7d: '7d', range14d: '14d', range30d: '30d', range90d: '90d', rangeToday: 'Today', customRange: 'Custom',
    dateStart: 'Start Date', dateEnd: 'End Date', cancel: 'Cancel', confirm: 'Confirm',
  ...
  zh: {
    ...
    range7d: '7 天', range14d: '14 天', range30d: '30 天', range90d: '90 天', rangeToday: '今日', customRange: '自定义',
    dateStart: '开始日期', dateEnd: '结束日期', cancel: '取消', confirm: '确定',
